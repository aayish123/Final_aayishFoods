    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          size="icon"
          variant="outline"
          className="relative h-10 w-10 rounded-full border-gray-200 hover:bg-[#fdfbf7] text-gray-700 focus-visible:ring-[#1a3b2b]"
        >
      ...
      <DropdownMenuContent align="end" className="w-[380px] rounded-2xl shadow-xl border border-gray-100 bg-white p-0 overflow-hidden">
        {/* Header */}
