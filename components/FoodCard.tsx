      ...
      <CardFooter className="p-5 pt-0">
        {currentQuantity > 0 ? (
          <div className="flex items-center justify-between w-full bg-muted/50 p-1.5 rounded-lg border border-border/50">
            <div className="flex items-center space-x-2">
              <Button
                ...
                className="h-8 w-8 rounded-md hover:bg-white hover:shadow-sm transition-all"
              >
              ...
              <Button
                ...
                variant="ghost"
                onClick={() => handleUpdateQuantity(currentQuantity + 1)}
                className="h-8 w-8 rounded-md hover:bg-white hover:shadow-sm transition-all text-primary"
          ...
          <Button
            ...
            className="w-full font-medium tracking-wide shadow-sm hover:shadow-md transition-all"
            disabled={!item.in_stock}
          >
