    ...
    <div className="min-h-screen bg-[#fdfbf7] flex">
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 flex lg:hidden bg-black/60 backdrop-blur-sm animate-fade-in" onClick={() => setMobileMenuOpen(false)}>
          <aside className="w-72 bg-[#5c2018] text-white flex flex-col h-full animate-slide-in-right" onClick={(e) => e.stopPropagation()}>
            <div className="h-20 flex justify-between items-center px-6 border-b border-[#4a1811]">
              ...
              <Button size="icon" variant="ghost" onClick={() => setMobileMenuOpen(false)} className="text-white hover:bg-[#4a1811]">
                <X className="h-6 w-6" />
              </Button>
            </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-20 bg-white border-b border-[#1a3b2b]/10 flex items-center justify-between px-6 lg:px-8 shadow-sm">
          <div className="flex items-center space-x-4">
            <Button size="icon" variant="ghost" className="lg:hidden hover:bg-gray-100" onClick={() => setMobileMenuOpen(true)}>
