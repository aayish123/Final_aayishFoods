  ...
  return (
    <div className="space-y-8 animate-fade-in pb-12">
            ...
            <Card key={order.id} className="bg-white border border-[#1a3b2b]/10 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
              ...
              <div className="p-5 border-t border-gray-100 bg-[#fdfbf7]/50 flex gap-2">
                <Button
                  ...
                  className="px-3 border-gray-200 bg-white text-gray-600 hover:bg-gray-50 shrink-0 h-10 rounded-xl"
                ...
                {activeTab === 'packing' && (
                  <Button
                    ...
                    className="w-full bg-[#1a3b2b] text-[#d4af37] text-xs h-10 font-bold hover:bg-[#122b20] rounded-xl"
                  >
                ...
                {activeTab === 'shipping' && (
                  <Button
                    ...
                    className="w-full bg-[#5c2018] text-[#d4af37] text-xs h-10 font-bold hover:bg-[#431610] rounded-xl"
                  >
                ...
                {activeTab === 'delivered' && (
                  <Button
                    ...
                    className="w-full bg-green-700 text-white text-xs h-10 font-bold hover:bg-green-800 rounded-xl"
                  >
                ...
                {activeTab === 'returns' && (
                  <Button
                    onClick={() => window.open(`/admin/orders/${order.id}`, '_blank')}
                    className="w-full bg-amber-600 text-white text-xs h-10 font-bold hover:bg-amber-700 rounded-xl"
                  >
                ...
                {activeTab === 'payment_review' && (
                  <div className="flex gap-2 w-full">
                    <Button
                      ...
                      variant="outline"
                      className="w-1/2 border-red-200 text-red-600 bg-red-50 hover:bg-red-100 text-xs h-10 font-bold rounded-xl"
                    >
                    ...
                    <Button
                      ...
                      className="w-1/2 bg-[#1a3b2b] text-[#d4af37] hover:bg-[#122b20] text-xs h-10 font-bold rounded-xl"
                    >
      ...
      <Dialog open={isShipDialogOpen} onOpenChange={setIsShipDialogOpen}>
        <DialogContent className="bg-white rounded-2xl border border-gray-100 max-w-md">
          <DialogHeader>
