        ...
        <div className="text-center mb-12 relative">
          ...
          {items.length > 0 && (
            <Button
              ...
              className="absolute right-0 bottom-0 text-muted-foreground hover:text-destructive hover:bg-destructive/10 border-border/60 hover:border-destructive/30 rounded-xl transition-all"
            >
