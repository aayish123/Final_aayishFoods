          ...
          <div className="lg:col-span-2">
            <Card className="shadow-xl shadow-primary/5 border border-border/40 rounded-2xl overflow-hidden">
              ...
              <CardContent className="p-0 divide-y divide-border/40">
                {items.map((item) => (
                  <div key={item.id + '-' + item.variantId} className="flex items-center space-x-6 p-6 hover:bg-muted/20 transition-colors">
                    <div className="h-24 w-24 rounded-xl overflow-hidden bg-muted border border-border/50 shrink-0">
                      <img
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">{item.variantLabel}</div>
                      <p className="text-primary font-bold text-lg">₹{item.price}</p>
                    </div>
                    <div className="flex flex-col items-end space-y-4">
                      <div className="flex items-center space-x-3 bg-white border border-border/60 rounded-lg p-1 shadow-sm">
                        <Button
                          variant="ghost"
                          size="icon"
                          onClick={() => handleQuantityChange(item.id, item.quantity - 1, item.variantId)}
                          className="h-8 w-8 rounded-md hover:bg-secondary/50 hover:text-primary transition-all"
                        >
                        ...
                        <Input
                          ...
                          className="w-12 h-8 text-center border-0 focus-visible:ring-0 p-0 font-semibold"
                          min="1"
                        />
                        <Button
                          variant="ghost"
                      ...
                      <Button
                        ...
                        className="text-muted-foreground hover:text-destructive hover:bg-destructive/10 px-2 h-8 transition-colors"
                      >
