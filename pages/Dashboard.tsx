            ...
            {showAddressForm ? (
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  <Button 
                    variant="outline" 
                    className="border-[#e5d4c0] hover:bg-primary/5 hover:text-primary rounded-xl"
                    onClick={() => {
                      setEditingAddress(null);
                      setShowAddressForm(true);
                      setAddressInput({
                          ...
                          <div className="flex justify-between items-start">
                            ...
                            <div className="flex gap-1.5">
                              <Button 
                                ...
                                className="h-8 w-8 hover:bg-[#FDF8F0] text-muted-foreground hover:text-primary rounded-lg"
                              >
