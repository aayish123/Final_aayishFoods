            ...
            {coupons.map((coupon) => (
              ...
              >
                <div className="flex">
                  ...
                  <div className="w-1/4 bg-primary/5 border-r border-[#e5d4c0] flex flex-col items-center justify-center p-4 text-primary">
                  ...
                  <CardContent className="w-3/4 p-6 flex flex-col justify-between">
                    ...
                    <div className="flex items-center justify-between gap-4 pt-2">
                      {/* Copy Coupon Badge */}
                      <div className="flex items-center gap-2 bg-[#f5e9da] px-3.5 py-2 border border-[#e5d4c0] rounded-lg">
                      ...
                      <Button
                        ...
                        className="rounded-lg bg-primary hover:bg-primary/95 text-white flex items-center gap-2 text-xs"
                      >
