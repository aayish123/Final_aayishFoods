...
const Header = () => {
  ...
  return (
    <header className="bg-background shadow-sm sticky top-0 z-50 pt-[env(safe-area-inset-top)]">
      {/* Main Navigation */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-border/40">
        <div className="flex justify-between items-center h-20">
          ...
          {/* Mobile Menu Toggle */}
          <button
            className="lg:hidden p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center text-foreground hover:bg-muted rounded-md transition-colors"
