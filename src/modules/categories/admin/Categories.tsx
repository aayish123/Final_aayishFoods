  ...
  return (
    <div className="space-y-8 animate-fade-in">
                    ...
                    <tr key={c.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-right space-x-2 whitespace-nowrap">
                        <Button
                          ...
                          className="h-11 w-11 sm:h-8 sm:w-8 text-blue-600 hover:bg-blue-50 flex items-center justify-center shrink-0"
                        >
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="w-[92vw] max-h-[90vh] overflow-y-auto sm:max-w-2xl bg-[#fdfbf7] border border-[#1a3b2b]/10 rounded-3xl p-6 shadow-2xl">
