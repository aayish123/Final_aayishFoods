                        ...
                        <TableCell className="text-right px-6 py-4">
                          <div className="flex justify-end gap-2">
                            <Button
                              ...
                              variant="ghost"
                              size="icon"
                              className="h-11 w-11 sm:h-8 sm:w-8 text-gray-500 hover:text-[#d4af37] hover:bg-amber-50 rounded-lg flex items-center justify-center shrink-0"
                            ...
                            <Button
                              ...
                              variant="ghost"
                              size="icon"
                              className="h-11 w-11 sm:h-8 sm:w-8 text-gray-500 hover:text-[#1a3b2b] hover:bg-[#1a3b2b]/5 rounded-lg flex items-center justify-center shrink-0"
                              title="Edit Coupon"
                            >
                            ...
                            <Button
                              ...
                              variant="ghost"
                              size="icon"
                              className="h-11 w-11 sm:h-8 sm:w-8 text-gray-500 hover:text-red-600 hover:bg-red-50 rounded-lg flex items-center justify-center shrink-0"
                              title="Delete Coupon"
                            >
