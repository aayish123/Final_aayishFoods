    ...
    <div className="space-y-8 animate-fade-in pb-16">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center space-x-3">
          <Button variant="ghost" size="icon" onClick={() => navigate('/admin/orders')} className="h-11 w-11 sm:h-9 sm:w-9 hover:bg-gray-100 shrink-0 flex items-center justify-center">
      ...
      <Dialog open={isEditNoteOpen} onOpenChange={setIsEditNoteOpen}>
        <DialogContent className="w-[92vw] max-h-[90vh] overflow-y-auto sm:max-w-md bg-[#fdfbf7] border border-[#1a3b2b]/10 rounded-2xl p-6">
          <DialogHeader>
