                      ...
                      <tr key={o.id} className="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td className="px-6 py-4 text-right">
                          <Button
                            ...
                            className="h-11 w-11 sm:h-8 sm:w-8 text-[#1a3b2b] hover:bg-gray-100 flex items-center justify-center shrink-0 inline-flex"
                          >
            ...
            <div className="flex justify-between items-center px-6 py-4 border-t border-gray-100 bg-[#fdfbf7]/50">
              ...
              <div className="flex gap-1">
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="rounded-lg border-gray-200 h-11 sm:h-8 px-4 sm:px-3 text-sm sm:text-xs shrink-0 flex items-center justify-center"
                >
