    ...
    <div className="space-y-8 animate-fade-in pb-16">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center space-x-3">
          <Button variant="ghost" size="icon" onClick={() => { window.formIsDirty = false; navigate('/admin/products'); }} className="h-11 w-11 sm:h-9 sm:w-9 hover:bg-gray-100 shrink-0 flex items-center justify-center">
          ...
          <TabsContent value="variants" className="space-y-6 mt-6 focus-visible:outline-none">
            <Card className="bg-white border border-[#1a3b2b]/10 rounded-2xl">
              <CardHeader className="border-b border-[#1a3b2b]/5 px-6 py-4 flex flex-row justify-between items-center">
                ...
                <Button type="button" onClick={handleAddVariant} className="bg-[#1a3b2b] text-[#d4af37] text-sm sm:text-xs h-11 sm:h-9 px-4 sm:px-3 font-bold rounded-xl">
                    ...
                    <div key={index} className="grid grid-cols-1 md:grid-cols-8 gap-4 items-end bg-[#fdfbf7]/60 p-4 rounded-xl border border-gray-100">
                      ...
                      <div className="flex justify-end">
                        <Button
                          ...
                          className="h-11 w-11 sm:h-10 sm:w-10 text-red-600 hover:bg-red-50 hover:text-red-800 flex items-center justify-center shrink-0"
                        >
                  ...
                  <div className="flex gap-6 items-center">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <Button
                        ...
                        className="bg-[#1a3b2b] text-[#d4af37] text-sm sm:text-xs h-11 sm:h-9 px-4 sm:px-3 font-bold rounded-xl"
                      >
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="text-sm sm:text-xs h-11 sm:h-9 px-4 sm:px-3 border-[#1a3b2b]/30 text-[#1a3b2b] font-bold rounded-xl"
                    >
                      <Plus className="h-4 w-4 mr-2" />
                      Add Gallery Image
                    </Button>
