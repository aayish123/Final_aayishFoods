                      ...
                      <tr key={p.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 text-right space-x-2 whitespace-nowrap">
                          <Button
                            ...
                            className="h-11 w-11 sm:h-8 sm:w-8 text-blue-600 hover:bg-blue-50 flex items-center justify-center shrink-0 inline-flex"
                          >
                          ...
                          <Button
                            ...
                            className="h-11 w-11 sm:h-8 sm:w-8 text-amber-600 hover:bg-amber-50 flex items-center justify-center shrink-0 inline-flex"
                          ...
                          <Button
                            ...
                            className="h-11 w-11 sm:h-8 sm:w-8 text-red-600 hover:bg-red-50 flex items-center justify-center shrink-0 inline-flex"
                          >
