  ...
  return (
    <div className="space-y-8 animate-fade-in pb-12">
                ...
                <div key={review.id} className="p-6 hover:bg-gray-50/50 transition-colors flex flex-col md:flex-row justify-between items-start gap-4">
                  ...
                  <div className="flex flex-wrap md:flex-nowrap gap-1.5 md:self-center shrink-0">
                    <Button
                      ...
                      className={`h-11 px-4 sm:h-9 sm:px-3 rounded-lg text-sm sm:text-xs font-bold border ${
                        review.is_featured
                    ...
                    {review.status !== 'approved' && (
                      <Button
                        ...
                        className="h-11 px-4 sm:h-9 sm:px-3 rounded-lg text-sm sm:text-xs font-bold border-green-100 text-green-700 hover:bg-green-50"
                      >
                    ...
                    {review.status !== 'rejected' && (
                      <Button
                        ...
                        className="h-11 px-4 sm:h-9 sm:px-3 rounded-lg text-sm sm:text-xs font-bold border-red-100 text-red-700 hover:bg-red-50"
                      >
                    ...
                    {review.status !== 'hidden' && (
                      <Button
                        ...
                        className="h-11 px-4 sm:h-9 sm:px-3 rounded-lg text-sm sm:text-xs font-bold border-gray-200 text-gray-500 hover:bg-gray-100"
                    ...
                    <Button
                      ...
                      className="h-11 px-4 sm:h-9 sm:px-3 rounded-lg text-sm sm:text-xs font-bold bg-[#1a3b2b] text-[#d4af37] hover:bg-[#122b20]"
                    >
      ...
      <Dialog open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
        <DialogContent className="w-[92vw] max-h-[90vh] overflow-y-auto bg-white rounded-2xl border border-gray-100 sm:max-w-lg">
          <DialogHeader>
