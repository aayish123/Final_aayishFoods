  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Try refreshing — if it keeps happening, head back home.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A modern shop for thoughtfully designed home, lighting, electronics, and apparel." },
      { property: "og:title", content: "Lumen & Co." },
  ...
  return (
    <footer className="mt-24 border-t border-border/60 bg-muted/40">
      <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 px-4 py-12 sm:px-6 md:flex-row md:items-center lg:px-8">
        <div>
          <p className="font-display text-xl font-semibold">Lumen &amp; Co.</p>
          <p className="mt-1 text-sm text-muted-foreground">Considered objects for daily life.</p>
        </div>
